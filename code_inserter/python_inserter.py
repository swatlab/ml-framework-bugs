...
class Inserter:
	...
	def getVersionArguments(self): # renamed to getAndFormatCommitNumber()
		"""
	...
	def commandFilepaths(self, commit_command): # renamed to executeChangedFilesPathsDiff()
		"""
	...
	def commandPatchfile(self, commit_command): # renamed to executePatchfileCommand
		"""
