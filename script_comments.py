        ...
        for i, issue in closed_issues.iterrows():
            ...
            while True:
                try:
                    ...
                    js_resp = resp.json()
                    print("Get page 1, issue ", issue.number,
                          csv.stem, " at ", datetime.datetime.now())
            ...
            for i in range(2, max_pages+1):
                ...
                while True:
                    try:
                        resp = all_issue_comments.get(
                            comments_uri, params=params)
                        print("Get page ", i, issue.number,
                              framw_row['framework'], " at ", datetime.datetime.now())
                        js_resp = resp.json()
