...
def analyze_python_file(file_contents_lines, lines_numbers):
    ...
    for file_content_line in file_contents_lines:
        ...
        for line_number in lines_numbers:
            ...
            if len(matches) == 1:
                insertable_line = (line_number, True)
                are_insterable_lines.append(insertable_line)
            ...
            while 0 <= syntax_index and len(matches) == 0: # & syntax_index != in lines_numbers 
                ...
                if len(matches) == 1:
                    ...
                    print(matches)
                    insertable_line = (syntax_index, True)
                    are_insertable_lines.append(insertable_line)
                else:
                    line_index -= 1
                    syntax_index -= 1
...
if __name__ == '__main__':
    filepaths = []
    lines_numbers = []
    filepaths.append("./python_inserter_copy.py")
    lines_numbers.append(121)
